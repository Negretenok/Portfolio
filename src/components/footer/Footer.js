            ...
            <footer className="footer">
                ...
                <div className='footerContact'> 
                    ...
                    <div className='contacts'>
                        ...
                        <a href='https://wa.me/qr/J5OC7SRORR2YA1'><img className='contact' src={tiktok} alt='tt'/></a>
                        <a href='https://www.tiktok.com/@nnurzhigit_11?_t=8raWEPNWCLY&_r=1'><img className='contact' src={whatsapp} alt='waths'/></a>
